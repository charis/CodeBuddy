...
const SkeletonForm = () => {
  return (
    <div className="border-4 rounded-l-md rounded-r-md border-gray-400 rounded shadow animate-pulse md:p-8 dark:border-gray-900">
...
const loading = () => {
    return (
      <main className="bg-dark-layer-2 min-h-screen">
        <div className="max-w-[1200px] mx-auto sm:w-4/12 w-full animate-pulse sm:pt-24">
          <SkeletonForm />
        </div>
      </main>
    );
