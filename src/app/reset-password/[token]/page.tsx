...
const VerifyUser:React.FC<VerifyUserProps> = ({params}) => {
     ...
     * {@code false} if the reset password token is invalid or
     * has expired or another error happes and {@code null}
              ...
              >
                ...
                >
                  ...
                  {validationError?.passwordConfirm &&
                    <ErrorMessage message={validationError.passwordConfirm._errors[0]} />
                  }
                </div>
            ...
            { success === true &&
              <div className="flex flex-col items-center justify-center min-h-screen py-2">
                <Image src="/images/password-update-success.png"
                       ...
                       width={200}
                />
                <h1 className="mt-2 p-2 text-2xl text-white center">Password Changed</h1>
                <h2 className="text-lg text-white">Your password was successfully updated</h2>
            ...
            { success === false &&
              <div className="flex flex-col items-center justify-center min-h-screen py-2">
                <Image src="/images/password-update-error.png"
                       ...
                       width={200}
                />
                <h1 className="mt-2 p-2 text-xl rounded-lg bg-red-600 text-white">Error Setting New Password</h1>
                <h2 className="mt-2 p-2 text-xl rounded-lg text-white">Make sure that your token is valid and has not expired</h2>
