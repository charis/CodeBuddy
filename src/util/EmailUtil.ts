"use server"; // This is required as the nodemailer works only in the backend environment
// Library imports
...
export async function sendEmail(email: string, type: EmailType):
    ...
    switch (type) {
        case EmailType.ACCOUNT_VERIFICATION:
             ...
             bodyHtml =  `<p>
                            Click <a href="${HOST_URL}/verify-user/${token}">here</a> to verify your email
        ...
        case EmailType.RESET_PASSWORD:
             ...
             bodyHtml =  `<p>
                            Click <a href="${HOST_URL}/reset-password/${token}">here</a> to reset your password
                            or copy and paste the link below in your browser.<br>
